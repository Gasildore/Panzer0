...
using Panzer0.TanksData;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;
using System.Threading.Tasks;
using static Panzer0.TanksData.TanksGameplayState;
...
namespace Panzer0.TanksData
{
    internal class Projectile : IGameObject
    {
        ...
        {
            if (Position.X >= 0 && Position.X < renderer._width && Position.Y >= 0 && Position.Y < renderer._height)
            {
                Console.OutputEncoding = Encoding.Unicode;
                renderer.SetPixel(Position.X * Cell.Width + 2, Position.Y * Cell.Height + 1, _bulletView, Owner.TankColor);
            }
        }
